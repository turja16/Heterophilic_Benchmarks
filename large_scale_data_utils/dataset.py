...
import gdown
from os import path
from large_scale_data_utils.load_data import load_twitch, load_fb100, load_twitch_gamer, DATAPATH
from large_scale_data_utils.data_utils import rand_train_test_idx, even_quantile_labels, dataset_drive_url
...
def load_nc_dataset(dataname, sub_dataname=''):
    ...
    elif dataname == 'fb100': # run Penn94
    ...
    elif dataname == 'arxiv-year': # run arxiv-year
        dataset = load_arxiv_year_dataset()
    elif dataname == 'pokec': # run pokec
        dataset = load_pokec_mat()
    elif dataname == 'snap-patents': # run snap-patents
    ...
    elif dataname == "genius": # run genius
        dataset = load_genius()
    elif dataname == "twitch-gamer": # run twitch-gamer
