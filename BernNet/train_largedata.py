...
def train(model, optimizer, features, edge_index):
    best_metric = 0
    patience = 0
    best_params = None
...
# large scale + geom
if args.dataset in ['deezer-europe', 'genius', 'penn94', 'arxiv-year', 'pokec', 'snap-patents', 'twitch-gamer', 'Cora', 'CiteSeer', 'PubMed', 'chameleon', 'cornell', 'film', 'squirrel', 'texas', 'wisconsin']:
...
for i in range(num_splits):
    ...
    test_metric = train(model, optimizer, features, edge_index)
